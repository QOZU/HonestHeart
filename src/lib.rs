...
#[derive(Debug)]
pub struct HonestHeartProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HonestHeartProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HonestHeart processing");
    
    let mut processor = HonestHeartProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HonestHeartProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HonestHeartProcessor::new(false);
